...
### *Akıllı Restoran, QR Menü ve Yapay Zekâ Destekli İnceleme Platformu*
...
**SmartMenu AI**, geleneksel restoran menülerini yapay zekâ destekli bir müşteri deneyimine dönüştüren web platformudur. Kullanıcılar QR kodlar üzerinden dinamik menülere erişebilir, ürün yorumları ve değerlendirmeleri yapabilir. 
...
---
 ...
 <h1>Hızlı Başlangıç (Zero-Configuration Docker)</h1>

Proje, herhangi bir ek bağımlılık (MS SQL Server veya LLM kurulumu) gerektirmeden **tek komutla** çalışacak şekilde konteynerize edilmiştir.
   ### <h1>Ön Koşullar</h1>
